      ...
      <div className="flex flex-col md:flex-row h-full">
        <aside className="relative flex-shrink-0 md:h-screen md:overflow-y-auto md:overflow-x-hidden p-6 pt-8 md:pt-6 flex flex-col gap-4 md:gap-6 md:border-r border-subtle md:w-[42%] md:shrink-0">
          ...
          <div className="flex flex-col md:flex-row items-center md:items-start gap-4 md:gap-4 justify-center md:justify-start md:pr-0">
            <div className="h-24 w-24 md:h-28 md:w-28 border border-subtle overflow-hidden flex-shrink-0 mx-auto md:mx-0" aria-hidden="true">
            ...
            <div className="min-w-0 text-center md:text-left">
              ...
              {/* Social links */}
              <div className="mt-2.5 md:mt-3 flex flex-wrap items-center gap-2 justify-center md:justify-start">
          ...
          {/* Big marketing copy */}
          <div className="mt-1.5 space-y-1.5 md:space-y-2 text-center md:text-left">
            <p className="text-[1.4rem] md:text-3xl lg:text-4xl font-semibold leading-tight tracking-tight text-balance">
